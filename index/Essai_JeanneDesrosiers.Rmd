...
> **Keywords** Écrire ici vos mots-clés
...
| Catégories | Critères pour l’assignation |
|:---|:---|
| Enjeux | La définition définit un déchet en fonction d’un autre enjeu. |
| Environnement | La définition fait référence aux impacts environnementaux des déchets. |
| Santé | La définition fait référence aux impacts sur la santé humaine des déchets. |
| Intérêt public | La définition fait référence aux questions d’intérêt public justifiant la gestion des déchets. |
| Sécurité | La définition fait référence au danger que représente les déchets. |
| Technologie | La définition fait référence aux capacités technologiques nécessaires pour la gestion des déchets. |
| Propriétés | La définition définit un déchet en fonction de ses propriétés. |
| Valeur | La définition fait référence à une perte ou diminution de valeur. |
| Utilité | La définition fait référence à une perte d’utilité. |
| Stratégies | La définition définit un déchet en fonction des stratégies de traitement possibles. |
| Réemploi | La définition fait référence au réemploi des déchets. |
| Recyclage | La définition fait référence au recyclage des déchets. |
| Valorisation | La définition fait référence à la valorisation des déchets. |
| Activités | La définition définit un déchet en fonction des activités de production. |
| Chaîne de valeur | La définition fait référence à l’ensemble de la chaîne de valeur. |
| État | La définition définit un déchet en fonction de son état. |
| Résidu | La définition distingue déchet et résidu. |
